...
fun highlightLookElements(
    ...
    val lookElementGazeMapAlteredByUser =
        json.decodeFromString<Map<String, Double>>(
            File(saveFolder, "lookElementGazeMapAlteredByUser.json").readText(Charsets.UTF_8),
        ).mapKeys {
            json.decodeFromString(LookElement.serializer(), it.key)
        }
